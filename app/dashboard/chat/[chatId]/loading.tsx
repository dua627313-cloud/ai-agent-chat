                  ...
                  <div className="space-y-3">
                    <div
                      className={`h-4 animate-pulse rounded w-[90%] ${
                        i % 2 === 0 ? "bg-blue-400/40" : "bg-gray-200"
                      }`}
                    />
                    ...
                    <div
                      className={`h-4 animate-pulse rounded w-[50%] ${
                        i % 2 === 0 ? "bg-blue-400/40" : "bg-gray-200"
                      }`}
                    />
                    <div className={`h-4 animate-pulse rounded w-[75%] ${
                        i % 2 === 0 ? "bg-blue-400/40" : "bg-gray-200"
                      }`} />
                      <div className={`h-4 animate-pulse rounded w-[60%] ${
                        i % 2 === 0 ? "bg-blue-400/40" : "bg-gray-200"
                      }`} />
                  </div>
                </div>
